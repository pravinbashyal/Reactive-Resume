    ...
    (state, { type, payload }) => {
      ...
      switch (type) {
        ...
        case 'on_import_jsonresume':
          ...
          newState.social.items = payload.social.items;
          newState.objective = payload.objective;

          sectionsWithItemsKeys.forEach((sectionKey) => {
            newState[sectionKey].items = fetchItems(payload[sectionKey]);
          });
